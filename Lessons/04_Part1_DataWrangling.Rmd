...
# dplyr filtering
#extract all rows that have zero in column depth
...
NTL.phys.data.Tuesday.9099 <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999))
...
#monmth function on lubdritate only works on things that are already data objects
