...
#or same map but in map view
mapView(huc8_sf, col.regions = "orange") + mapView(neuse_sf, col.regions = "purple")
...
svi2018_nc_raw <- read.csv(
  ...
  colClasses = c('FIPS' = 'factor')) %>% #this insures that you don't lost the preceding zero in the fips code; string as factor wouldn't work here.
