...
> Answer: Never remove NAs for time series analysis, but for other types of analysis it can be appropriate.

```{r removeNA}
#removes rows that have NAs
...
```{r fixformartDate}
#convert data object back into character 
USGS.flow.data$datetime <- format(USGS.flow.data$datetime, "%y%m%d")

#create function to paste 20 and 19 into the dates, depdning on whether it is less than or greater than
