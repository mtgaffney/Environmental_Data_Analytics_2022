...
```{r, fig.height = 3, fig.width = 4, warning = FALSE}
#create theme object that can be called for every line of code
...
#this code sets the theme globally I think
theme_set(mytheme)
...
NvsP2 <-
  ...
  xlab("TP (Micgrograms per Liter)") + ylab("TN (Micrograms per liter)") +
...
ggplot(Neonics) +
  geom_bar(aes(x = reorder(Endpoint, Endpoint, FUN = length))) + 
