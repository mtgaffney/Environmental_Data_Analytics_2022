...
# Lists ---- 
#distionary in python, more or less
...
```{r}
d.high <- c(41, 43, 45, 35, 42, 49, 52, 56, 66, 95)
#add an l to make it interger
d.low <- c(19, 25, 27, 18, 23, 25, 29, 43, 49, 36)
```
...
d.cels <- convert(d.high)
d.celcius <- convert(d.low)
```

Combine your four vectors into a data frame and add informative column names.

```{r}
durham.temps <- data.frame("F High" = d.high, "F Low" = d.low, "C High" = d.cels, "C Low" = d.celcius)
```
