...
#low p-value, this means that we overturn the null-hypothesis that the data are stationary
#we conclude that we have a trust

#same analysis with a different statistical tool
wind_data_trend2 <- trend::smk.test(wind_data_ts)
# Inspect results
wind_data_trend2
summary(wind_data_trend2)

#Visualization with the original data
wind_data_plot <-
...
> Answer: There is a decrease trend in the average wind speed over time. We spotted this with the decomposition initially, but we were able to conclude this using the seasonal Mann-Kendall test.
